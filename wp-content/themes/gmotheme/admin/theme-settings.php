...
//Folder Paths for "type" => "images"
        ...
        // Home Section Start
        $options[] = array("name" => __('Home Section', 'framework_localize'),
            "type" => "heading");

        $options[] = array( 	"name" 		=> "Home Section",
						"desc" 		=> "",
						"id" 		=> "general_info",
						"std" 		=> "",
						"icon" 		=> true,
        ...
        $options[] = array("name" => __('Top Page', 'framework_localize'),
            "desc" => __('Upload a custom logo for your Website.', 'framework_localize'),
            "id" => $shortname . "_sitelogo",
            "std" => "",
            "type" => "upload");
        $options[] = array("name" => __('Text Descript', 'framework_localize'),
            "desc" => __('Text Description for top page.', 'framework_localize'),
            "id" => $shortname . "_sitedesc",
            "std" => "",
            "type" => "textarea");
