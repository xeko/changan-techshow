...
function html5blank_nav() {
    wp_nav_menu(
            array(
                ...
                'link_before' => '',
                'link_after' => '',
                'items_wrap' => '<ul id="main-nav" class="nav navbar-define navbar-right text-right">%3$s</ul>',
                'depth' => 0,
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-pull-2 col-md-push-2 text-center">
                ...
                echo '<table class="table-responsive table table text-center" id="blog-news">';
                ...
                foreach ($allpost as $post):
                    ...
                    ?>
                    <tr>
                        <td class="tnews"><a href="<?php echo get_post_permalink($post->ID); ?>"><?php echo get_the_date('Y.m.d') ?></a></td>
            ...
            <?php if ($display > 3): ?>
                ...
                <div class="col-md-4">
                    <a href="<?php echo get_category_link(3) ?>" class="text-center"><span class="text-size-14">もっと見る</span></a>
                </div>
                <div class="col-md-4"></div>
            <?php endif; ?>
        </div>
    ...
    if ($categories) {
        ...
        if ($my_query->have_posts()) {
            ...
            while ($my_query->have_posts()) {
                ...
                ?>
                <div class="row">
                    <div class="col-md-12 blog-title text-left">
                        <div id="re-post">
...
function top_nav() {
    wp_nav_menu(
            array(
                ...
                'link_before' => '',
                'link_after' => '',
                'items_wrap' => '<ul id="extra-menu" class="nav navbar-nav navbar-right">%3$s</ul>',
                'depth' => 0,
                'walker' => ''
            )
    );
...
function func_faq($args) {
    ...
    <div class="spacer-xs"></div>
    <?php if ($display > 5): ?>
    <a href="<?php echo get_post_type_archive_link('faq') ?>" class="text-right"><span class="text-size-14">もっと見る</span></a>
    <?php endif; ?>
    <?php
    $content = ob_get_contents();
    ob_end_clean();
