...
<?php } ?>
            ...
            <p class="login-submit col-md-4 text-right">
                <button type="submit" name="wp-submit" id="loginform-submit" tabindex="40" class="btn btn-primary btn-sm"><i class="fa fa-lock"></i> &nbsp; <?php _e('Log In','wpdmpro'); ?></button>
            ...
            $('#loginform').submit(function () {
                ...
                $(this).ajaxSubmit({
                    success: function (res) {
                        if (!res.match(/success/ig)) {
                            $('#loginform').prepend("<div class='alert alert-danger'>" + res + "</div>");
