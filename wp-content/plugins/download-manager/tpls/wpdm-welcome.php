         ...
         <div class="row">
            ...
            <div class="col-md-12"><br style="clear:both"/><hr/>
                 ...
                 <ul style="list-style:square !important;margin-left:15px">
                     <li>Fixed issue with file attachment missing message</li>
                     <li>Rearracnged plugin files</li>
                     <li>New filter hook <code>wpdm_user_dashboard_menu</code> to add new menu item with user dashboard</li>
                 </ul>
                <br>
             </div>
